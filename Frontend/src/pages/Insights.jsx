      ...
      <div className="card p-6 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-600 to-ink-900 text-white flex items-center justify-center shadow-lg shadow-black/15">
              <Sparkles size={18} />
            </div>
          ...
          <div style={{ width: "100%", height: 240 }}>
            <ResponsiveContainer>
              <BarChart data={compareData}>
                ...
                <Bar dataKey="This week" fill="#b48b5c" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
