      ...
      {step === 0 && (
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea className="input resize-none" rows={3} placeholder="e.g. Get fitter, read more, reduce phone time..." value={goals} onChange={(e) => setGoals(e.target.value)} autoFocus />
          </div>
      ...
      {step === 1 && (
        <div className="space-y-4">
          <div>
            ...
            <textarea className="input resize-none" rows={3} placeholder="e.g. Early morning, late evenings..." value={productiveTime} onChange={(e) => setProductiveTime(e.target.value)} autoFocus />
          </div>
      ...
      {step === 2 && (
        <div className="space-y-4">
          <div>
            ...
            <textarea className="input resize-none" rows={3} placeholder="e.g. Gym in the morning, journaling at night..." value={struggles} onChange={(e) => setStruggles(e.target.value)} autoFocus />
          </div>
          ...
          <div className="flex justify-between gap-2">
            ...
            <button className="btn-primary" onClick={submit} disabled={loading || !struggles.trim()}>
              {loading ? (
                <>
